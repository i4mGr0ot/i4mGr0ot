...
ART_PNG_LIGHT = "portrait-light.png"
ART_PNG_DARK = "portrait-dark.png"
...
def build() -> str:
    ...
    if LAYOUT == "image":
        ...
        return header + (
            ...
            '<picture>\n'
            f'  <source media="(prefers-color-scheme: dark)" srcset="{ART_PNG_DARK}">\n'
            f'  <img src="{ART_PNG_LIGHT}" alt="ASCII portrait"'
